...
// sparkModelVariants 返回所有归一到 spark 的模型 ID，包括本 fork 保留的
// reasoning-effort 别名。从 codexModelMap 派生，使集合与别名表单一来源、不漂移。
...
// 与空 mapping 透传行为一致，同时允许本 fork 的 effort 别名继续进入统一归一化流程。
