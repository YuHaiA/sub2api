...
// SanitizeReasoning removes malformed GPT reasoning ciphertext before the
// request reaches an upstream that would reject the entire turn.
func SanitizeReasoning(body []byte) []byte {
