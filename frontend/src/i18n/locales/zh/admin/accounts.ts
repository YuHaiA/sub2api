export default {
    accountHealth: {
      title: '账号健康',
      description: '检查账号可调度状态、模型可用性和令牌刷新任务'
    },
    accounts: {
      title: '账号管理',
      ...
      intervalUnit: { minute: '分钟', hour: '小时' },
      autoCheckModel: '自动检查模型',
      autoCheckSave: '保存设置',
      autoCheckSaved: '自动健康检查设置已保存',
      healthCheckAll: '立即检查',
      healthCheckRunning: '检查中...',
      healthCheckRunStarted: '健康检查已开始',
      ...
      deleteUnhealthyConfirm: '确定要物理删除这些账号吗？匹配状态：{statuses}。此操作不可撤销。',
      deleteUnhealthyDone: '已删除 {count} 个异常账号',
      deleteStatusTitle: '批量删除范围',
      deleteStatusHint: '可按账号状态或健康检查状态选择。',
      deleteStatusRequired: '请至少选择一种要删除的账号状态或健康状态',
      deleteHealthStatus: '健康检查：{status}',
      deleteAccountStatus: { disabled: '账号状态：停用', inactive: '账号状态：停用', error: '账号状态：错误', rate_limited: '账号状态：限流中', temp_unschedulable: '账号状态：临时不可调度', unschedulable: '账号状态：不可调度' },
      healthStatus: { all: '全部健康状态', healthy: '健康', constrained: '受限', unavailable: '不可用', unchecked: '未检查' },
      queueRunning: '运行中：{task}',
      queuePending: '排队中：{task}',
      queueTask: { healthManual: '手动健康检查', healthAuto: '自动健康检查', refreshManual: '手动刷新令牌', refreshAuto: '自动刷新令牌', none: '无任务' },
      healthSummary: { total: '账号总数', healthy: '健康账号', healthyHint: '最近检测通过，可参与调度。', constrained: '受限账号', constrainedHint: '可用但存在限流、配额或其他调度限制。', unavailable: '不可用账号', unavailableHint: '最近检测失败，建议复查或重新授权。', unchecked: '未检查 {count} 个', completedCount: '已完成', pendingCount: '待处理', neverChecked: '从未检查', lastChecked: '上次检查：{time}', progressLive: '当前检测任务实时进度', progressIdle: '暂无运行中的检测任务' },
      tokenRefresh: { tab: 'Token 刷新', title: '自动刷新 Token', hint: '定期刷新 OAuth 账号令牌。', enabled: '启用 Token 自动刷新', disabledHint: 'Token 自动刷新已关闭', interval: '刷新间隔', intervalHint: '刷新间隔必须大于 0', unit: '单位', unitHour: '小时', unitDay: '天', batchSize: '每批数量', batchHint: '每批数量必须在 1 到 50 之间', scope: '刷新范围', scopeAll: '全部账号', scopeGroup: '指定分组', group: '分组', groupPlaceholder: '选择分组', healthStatus: '健康状态', healthStatusAll: '全部状态', groupRequired: '请选择要刷新的分组', save: '保存设置', saved: 'Token 自动刷新设置已保存', runNow: '立即刷新', runStarted: 'Token 刷新任务已开始', runAlreadyRunning: '已有 Token 刷新任务正在运行', running: '刷新中...', runningProgress: 'Token 刷新任务正在运行', lastRunAt: '上次运行：{time}', lastRunTotal: '上次总数', lastRunSuccess: '上次成功', lastRunFailed: '上次失败', completedCount: '已完成', pendingCount: '待处理', currentBatch: '当前批量' },
