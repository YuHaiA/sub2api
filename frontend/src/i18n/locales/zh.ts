export default {
  ...
  admin: {
    ...
    settings: {
      ...
      deploy: {
        title: '部署更新',
        description: '配置 Docker 部署参数，并在后台直接触发应用更新。',
        enabled: '启用部署模式',
        enabledHint: '启用后，版本角标里的“立即更新”和这里的“立即部署更新”都会走 Docker 更新逻辑。',
        sourceType: '更新来源',
        sourceTypeImage: '镜像仓库',
        sourceTypeArchive: 'GitHub 压缩包',
        defaultImage: '默认镜像',
        defaultImagePlaceholder: '例如 weishaw/sub2api:latest',
        allowedImagePrefix: '允许镜像前缀',
        allowedImagePrefixPlaceholder: '例如 weishaw/sub2api:',
        archiveUrl: '压缩包地址',
        archiveUrlPlaceholder: '例如 GitHub Release 上的 tar 下载地址',
        loadedImage: '压缩包内镜像名',
        loadedImagePlaceholder: '例如 sub2api-local:deploy-ui',
        serviceName: '服务名',
        composeProjectDir: 'Compose 项目目录',
        composeFile: 'Compose 文件路径',
        composeFilePlaceholder: '留空表示使用项目目录下默认 docker-compose.yml',
        dockerBinary: 'Docker 命令',
        composeBinary: 'Compose 命令',
        status: '部署状态',
