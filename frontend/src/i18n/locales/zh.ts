  ...
  admin: {
    ...
    accounts: {
      ...
      healthSummary: {
        total: '账号总数',
        healthy: '健康账号',
        healthyHint: '最近检测通过，可参与调度。',
        constrained: '受限账号',
        constrainedHint: '可用但存在限流、配额或其他调度限制。',
        unavailable: '不可用账号',
        unavailableHint: '最近检测失败，建议复查或重新授权。',
        unchecked: '未检查 {count} 个',
        completedCount: '已完成',
        pendingCount: '待处理',
        neverChecked: '从未检查',
        lastChecked: '上次检查：{time}',
        progressLive: '当前检测任务实时进度',
        progressIdle: '暂无运行中的检测任务'
      },
      tokenRefresh: {
        tab: 'Token 刷新',
        title: '自动刷新 Token',
        hint: '定期刷新 OAuth 账号令牌，减少请求时临时失效。',
        enabled: '启用 Token 自动刷新',
        disabledHint: 'Token 自动刷新已关闭',
        interval: '刷新间隔',
        intervalHint: '刷新间隔必须大于 0',
        unit: '单位',
        unitHour: '小时',
        unitDay: '天',
        batchSize: '每批数量',
        batchHint: '每批数量必须在 1 到 50 之间',
        scope: '刷新范围',
        scopeAll: '全部账号',
        scopeGroup: '指定分组',
        group: '分组',
        ...
        runNow: '立即刷新',
        runStarted: 'Token 刷新任务已开始',
        runAlreadyRunning: '已有 Token 刷新任务正在运行',
        running: '刷新中...',
        runningProgress: 'Token 刷新任务正在运行',
        lastRunAt: '上次运行：{time}',
        lastRunTotal: '上次总数',
        lastRunSuccess: '上次成功',
        lastRunFailed: '上次失败',
      ...
      dataImport: '导入',
      deduplicate: '去除重复账号',
      deduplicateConfirm: '将按当前列表筛选条件去除重复账号，并保留每组中 ID 最小的账号。确认继续？',
      deduplicateSuccess: '去重完成：删除 {deleted} 个重复账号，命中 {groups} 组，保留 {kept} 个账号',
      deduplicateFailed: '账号去重失败',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      viewColumns: '列显示',
      ...
      dataImportWarning: '导入将创建新账号与代理；可选绑定目标分组，请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportGroup: '目标分组',
      dataImportGroupNone: '不绑定分组',
      dataImportButton: '开始导入',
      dataImporting: '导入中...',
      dataImportSelectFile: '请选择数据文件',
      dataImportLoadGroupsFailed: '加载分组失败',
