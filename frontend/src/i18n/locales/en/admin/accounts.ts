export default {
    accountHealth: {
      ...
      description: 'Check account schedulability, model availability, and token refresh jobs'
    },
    accounts: {
      ...
      autoCheckIntervalHint: 'Check account availability on a schedule; incompatible platforms use their default probe model.',
      autoCheckIntervalInvalid: 'Check interval must be a positive whole number',
      intervalUnit: { minute: 'Minutes', hour: 'Hours' },
      autoCheckModel: 'Auto-check model',
      autoCheckSave: 'Save Settings',
      autoCheckSaved: 'Automatic health check settings saved',
      healthCheckAll: 'Check Now',
      healthCheckRunning: 'Checking...',
      healthCheckRunStarted: 'Health check started',
      ...
      deleteUnhealthyConfirm: 'Physically delete accounts matching: {statuses}? This cannot be undone.',
      deleteUnhealthyDone: 'Deleted {count} unhealthy account(s)',
      deleteStatusTitle: 'Bulk Delete Scope',
      deleteStatusHint: 'Select account statuses or health-check statuses.',
      deleteStatusRequired: 'Select at least one account status or health status to delete',
      deleteHealthStatus: 'Health check: {status}',
      deleteAccountStatus: { disabled: 'Account status: Disabled', inactive: 'Account status: Inactive', error: 'Account status: Error', rate_limited: 'Account status: Rate limited', temp_unschedulable: 'Account status: Temp unschedulable', unschedulable: 'Account status: Unschedulable' },
      healthStatus: { all: 'All health statuses', healthy: 'Healthy', constrained: 'Constrained', unavailable: 'Unavailable', unchecked: 'Unchecked' },
      queueRunning: 'Running: {task}',
      queuePending: 'Pending: {task}',
      queueTask: { healthManual: 'Manual health check', healthAuto: 'Automatic health check', refreshManual: 'Manual token refresh', refreshAuto: 'Automatic token refresh', none: 'No task' },
      healthSummary: { total: 'Total Accounts', healthy: 'Healthy', healthyHint: 'Recently checked and available for scheduling.', constrained: 'Constrained', constrainedHint: 'Available, but affected by rate limits, quota, or scheduling constraints.', unavailable: 'Unavailable', unavailableHint: 'Recent check failed; review or re-authorize these accounts.', unchecked: '{count} unchecked', completedCount: 'Completed', pendingCount: 'Pending', neverChecked: 'Never checked', lastChecked: 'Last checked: {time}', progressLive: 'Live progress for the current check', progressIdle: 'No health check is currently running' },
      tokenRefresh: { tab: 'Token Refresh', title: 'Automatic Token Refresh', hint: 'Refresh OAuth account tokens on a schedule.', enabled: 'Enable automatic token refresh', disabledHint: 'Automatic token refresh is disabled', interval: 'Refresh interval', intervalHint: 'Refresh interval must be greater than 0', unit: 'Unit', unitHour: 'Hour', unitDay: 'Day', batchSize: 'Batch size', batchHint: 'Batch size must be between 1 and 50', scope: 'Refresh scope', scopeAll: 'All accounts', scopeGroup: 'Specific group', group: 'Group', groupPlaceholder: 'Select group', healthStatus: 'Health status', healthStatusAll: 'All statuses', groupRequired: 'Please select a group to refresh', save: 'Save Settings', saved: 'Token refresh settings saved', runNow: 'Run Now', runStarted: 'Token refresh job started', runAlreadyRunning: 'A token refresh job is already running', running: 'Refreshing...', runningProgress: 'Token refresh job is running', lastRunAt: 'Last run: {time}', lastRunTotal: 'Last Run Total', lastRunSuccess: 'Last Run Success', lastRunFailed: 'Last Run Failed', completedCount: 'Completed', pendingCount: 'Pending', currentBatch: 'Current Batch' },
