export default {
  ...
  admin: {
    ...
    settings: {
      ...
      deploy: {
        title: 'Deployment',
        description: 'Configure Docker deployment parameters and trigger application updates from the admin panel.',
        enabled: 'Enable deployment mode',
        enabledHint: 'When enabled, both the version badge update button and the button here will use the Docker deployment flow.',
        sourceType: 'Update source',
        sourceTypeImage: 'Container registry',
        sourceTypeArchive: 'GitHub tar package',
        defaultImage: 'Default image',
        defaultImagePlaceholder: 'For example weishaw/sub2api:latest',
        allowedImagePrefix: 'Allowed image prefix',
        allowedImagePrefixPlaceholder: 'For example weishaw/sub2api:',
        archiveUrl: 'Archive URL',
        archiveUrlPlaceholder: 'For example the tar asset URL from a GitHub Release',
        loadedImage: 'Image name inside archive',
        loadedImagePlaceholder: 'For example sub2api-local:deploy-ui',
        ...
        dockerBinary: 'Docker command',
        composeBinary: 'Compose command',
