  ...
  admin: {
    ...
    accounts: {
      ...
      healthStatus: {
        ...
        bannedOrExhausted: 'Banned or Exhausted',
      ...
      healthSummary: {
        ...
        healthyHint: 'Healthy totals include accounts that are currently rate limited',
        bannedOrExhausted: 'Banned or Exhausted',
        bannedOrExhaustedHint: 'Includes banned, 402, and quota exhausted accounts',
    ...
    settings: {
      ...
      tabs: {
        ...
        deploy: {
          title: 'Deployment',
          description: 'Configure Git-based deployment and let the host rebuild the Docker service from the latest repository code.',
          enabled: 'Enable deployment mode',
          enabledHint: 'When enabled, the admin button and the host manual script will use the same Git sync deployment flow.',
          agentHintTitle: 'Deployment runs on the host',
          agentHintBody: 'Sub2API still runs in Docker. The host script performs git pull, docker build, and docker-compose up so the container does not need direct access to host paths.',
          repoUrl: 'Repository URL',
          repoUrlPlaceholder: 'For example https://github.com/YuHaiA/sub2api.git',
          branch: 'Branch',
          branchPlaceholder: 'For example main',
          repoDir: 'Source directory',
          repoDirPlaceholder: 'For example /home/ec2-user/sub2api-source',
          agentUrl: 'Agent URL',
          ...
          manualCommandHint: 'After copying the host script to /home/ec2-user/sub2api-deploy/bin/deploy-from-git.sh, you can run this command directly on the server.',
