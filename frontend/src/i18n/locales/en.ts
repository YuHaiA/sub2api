  ...
  admin: {
    ...
    accounts: {
      ...
      healthSummary: {
        ...
        healthy: 'Healthy',
        healthyHint: 'Recently checked and available for scheduling.',
        constrained: 'Constrained',
        constrainedHint: 'Available, but affected by rate limits, quota, or scheduling constraints.',
        unavailable: 'Unavailable',
        unavailableHint: 'Recent check failed; review or re-authorize these accounts.',
        unchecked: '{count} unchecked',
        completedCount: 'Completed',
        pendingCount: 'Pending',
        neverChecked: 'Never checked',
        lastChecked: 'Last checked: {time}',
        progressLive: 'Live progress for the current check',
        progressIdle: 'No health check is currently running'
      },
      tokenRefresh: {
        tab: 'Token Refresh',
        title: 'Automatic Token Refresh',
        hint: 'Refresh OAuth account tokens on a schedule to reduce request-time token failures.',
        enabled: 'Enable automatic token refresh',
        disabledHint: 'Automatic token refresh is disabled',
        interval: 'Refresh interval',
        intervalHint: 'Refresh interval must be greater than 0',
        unit: 'Unit',
        unitHour: 'Hour',
        unitDay: 'Day',
        batchSize: 'Batch size',
        batchHint: 'Batch size must be between 1 and 50',
        scope: 'Refresh scope',
        ...
        runNow: 'Run Now',
        runStarted: 'Token refresh job started',
        runAlreadyRunning: 'A token refresh job is already running',
        running: 'Refreshing...',
        runningProgress: 'Token refresh job is running',
        lastRunAt: 'Last run: {time}',
        lastRunTotal: 'Last Run Total',
        lastRunSuccess: 'Last Run Success',
      ...
      dataImport: 'Import',
      deduplicate: 'Remove Duplicate Accounts',
      deduplicateConfirm: 'Duplicate accounts matching the current list filters will be removed, keeping the lowest ID in each group. Continue?',
      deduplicateSuccess: 'Deduplication complete: removed {deleted} duplicate accounts across {groups} groups, kept {kept} accounts',
      deduplicateFailed: 'Failed to deduplicate accounts',
      ...
      dataImportWarning: 'Import will create new accounts/proxies; you can optionally bind all imported accounts to a target group. Ensure existing data does not conflict.',
      dataImportFile: 'Data file',
      dataImportGroup: 'Target Group',
      dataImportGroupNone: 'Do not bind a group',
      dataImportButton: 'Start Import',
      dataImporting: 'Importing...',
      dataImportSelectFile: 'Please select a data file',
      dataImportLoadGroupsFailed: 'Failed to load groups',
    ...
    settings: {
      ...
      site: {
        ...
        tablePageSizeOptionsPlaceholder: '10, 20, 50, 100, 500, 1000',
