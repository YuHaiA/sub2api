export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      deduplicateAction: 'Remove Duplicates',
      deduplicateRunning: 'Removing...',
      deduplicateConfirm: 'Remove duplicate accounts in the current filter scope. Accounts with the same platform + type + name keep only the earliest record.',
      deduplicateConfirmButton: 'Remove Duplicates',
      deduplicateCompleted: 'Duplicate cleanup finished: deleted {deleted} accounts across {groups} duplicate groups',
      deduplicateFailed: 'Failed to remove duplicate accounts',
      healthCheckAll: 'Batch Health Check',
      healthCheckSelected: 'Check Selected',
      healthCheckRunning: 'Checking...',
      healthCheckCompleted: 'Completed health checks for {count} accounts',
      healthCheckFailed: 'Failed to run account health check',
      ...
      autoCheckInterval: 'Interval (minutes)',
      autoCheckIntervalHint: 'Minimum 1 minute; 30 minutes or more is recommended.',
      ...
      tokenRefresh: {
        ...
        group: 'Target group',
        groupPlaceholder: 'Select a group to refresh',
        groupRequired: 'Please select a group to refresh',
        save: 'Save token refresh config',
        saved: 'Automatic token refresh config saved',
        runNow: 'Run once now',
        running: 'Refreshing...',
        runStarted: 'Background refresh started. Stats will update shortly.',
        runAlreadyRunning: 'A background refresh is already running.',
        runningProgress: 'Background refresh is running. Progress will update automatically.',
      ...
      deleteUnhealthyDone: 'Deleted {count} unavailable accounts',
      healthStatus: {
        all: 'All health statuses',
        healthy: 'Healthy',
        constrained: 'Quota Exhausted or Rate Limited',
      ...
      healthSummary: {
        ...
        healthyHint: 'Counts only accounts that are fully healthy',
        constrained: 'Quota Exhausted or Rate Limited',
        constrainedHint: 'Includes rate limited, 402, and quota exhausted accounts',
    ...
    settings: {
      ...
      tabs: {
        ...
        deploy: {
          title: 'Deployment',
          description: 'Configure GitHub package deployment and let the host update the Docker service from the latest image archive.',
          enabled: 'Enable deployment mode',
          enabledHint: 'When enabled, the admin button and the host manual script will use the same package-based deployment flow.',
          agentHintTitle: 'Deployment runs on the host',
          agentHintBody: 'Sub2API still runs in Docker. The host script downloads the latest GitHub image package, runs docker load, docker tag, and docker-compose up so the container does not need direct access to host paths.',
          archiveUrl: 'Package URL',
          archiveUrlPlaceholder: 'For example the tar asset URL from a GitHub Release',
          loadedImage: 'Image name inside package',
          loadedImagePlaceholder: 'For example sub2api-gha:docker-deploy',
          defaultImage: 'Target image tag',
          defaultImagePlaceholder: 'For example weishaw/sub2api:latest',
          agentUrl: 'Agent URL',
          agentUrlPlaceholder: 'For example http://172.17.0.1:18080',
          agentToken: 'Agent token',
          agentTokenPlaceholder: 'Leave empty to disable Bearer token validation',
          agentTimeout: 'Agent timeout (seconds)',
          agentInsecureTls: 'Allow insecure TLS',
          agentInsecureTlsHint: 'Enable only when the agent uses a self-signed HTTPS certificate.',
          serviceName: 'Service name',
          composeProjectDir: 'Compose project directory',
          composeFile: 'Compose file path',
          composeFilePlaceholder: 'Leave empty to use the default docker-compose.yml in the project directory',
          manualCommand: 'Manual deploy command',
